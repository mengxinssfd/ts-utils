import {isUndefined, typeOf} from "../../core/src/dataType";
...
export const isDom: (target: any) => target is HTMLElement = isUndefined(root.HTMLElement) ? isDomIe8 : isDomStandard;
