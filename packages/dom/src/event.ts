...
export function addDragEventListener({
  ...
  onMove,
  onUp,
  capture = { down: false, up: true, move: false },
}: {
 ...
 * @param capture
 */
export function addScaleEventListener(
  el: HTMLElement | string,
  onScale: (distance: number, startDistance: number) => void,
  capture: {
    down?: boolean;
    up?: boolean;
    move?: boolean;
...
export function isVisible(
  target: HTMLElement,
  container: HTMLElement | typeof window = window,
): boolean {
