...
test('typeOf', () => {
  ...
  // 非6
  expect(fn(emptyFn)).toBe('function');
...
test('isArrayLike', () => {
  ...
  expect(type.isArrayLike(emptyFn)).toBe(false);
});
test('isArray', () => {
  ...
  expect(type.isArray(emptyFn)).toBeFalsy();
...
test('isNumber', () => {
  ...
  expect(type.isNumber(emptyFn)).toBeFalsy();
...
test('isFunction', () => {
  ...
  expect(type.isFunction(emptyFn)).toBeTruthy();
});
test('isString', () => {
...
test('isEmptyObject', () => {
  ...
  // eslint-disable-next-line @typescript-eslint/no-empty-function
  expect(type.isEmptyObject(function () {})).toBeFalsy();
});
test('isEmpty', () => {
  ...
  // eslint-disable-next-line @typescript-eslint/no-empty-function
  expect(type.isEmpty(function () {})).toBeFalsy();
  expect(
    type.isEmpty({
      // eslint-disable-next-line @typescript-eslint/no-empty-function
      a: function () {},
...
test('isPromiseLike', () => {
  ...
  expect(type.isPromiseLike([])).toBe(false);
  expect(type.isPromiseLike([true])).toBe(false);
  expect(type.isPromiseLike(emptyFn)).toBe(false);
...
test('isEqual', () => {
  ...
  // eslint-disable-next-line @typescript-eslint/no-empty-function
  expect(type.isEqual(emptyFn, () => {})).toBeFalsy();
