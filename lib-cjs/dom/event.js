...
exports.addScaleEventListener = addScaleEventListener;
...
function isVisible(target, container = window) {
 ...
 * @param [offset=10]
 */
function isScrollStart(el, direct = "vertical", offset = 10) {
    if (direct === "vertical") {
...
exports.isScrollStart = isScrollStart;
